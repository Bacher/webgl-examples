...
function parseObj(objText) {
    ...
    for (let polygon of polygons) {
        for (let point of polygon) {
            normals[point.vertex * 3] = preNormals[point.normal * 3];
            normals[point.vertex * 3 + 1] = preNormals[point.normal * 3 + 1];
            normals[point.vertex * 3 + 2] = preNormals[point.normal * 3 + 2];
        }
    }
